...
d3.tsv('van_gogh_additional_measurements.tsv', _________________{
  ...
  svg.selectAll(____________)
      .data(data)
    .enter()
      .append(____________)
        .attr(____________, function(d){ return xScale(d.ratio)})
        .attr(____________, function(d){ return yScale(d.Shape_Count) })
        .attr(____________, 4)
        .attr(____________, function(d){ return color(d.Year)})
